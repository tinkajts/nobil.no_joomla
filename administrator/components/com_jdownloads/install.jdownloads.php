...
function com_install() {
    ...
    require_once(JPATH_SITE."/administrator/components/com_jdownloads/helpers/jd_layouts.php");
      ...
      if (!$is_update){
          ...
          $query[] = "INSERT INTO ".$database->nameQuote('#__jdownloads_config')." (setting_name, setting_value) VALUES ('countdown.text', '$WAITING_NOTE_TEXT');"."\n";
		  ...
		  $query[] = "INSERT INTO ".$database->nameQuote('#__jdownloads_config')." (setting_name, setting_value) VALUES ('user.message.when.zero.points', '".$AUP_FE_MESSAGE_NO_DOWNLOAD."');"."\n";
		  ...
		  $query[] = "INSERT INTO ".$database->nameQuote('#__jdownloads_config')." (setting_name, setting_value) VALUES ('limited.download.reached.message', '$message_amount_files_limit');"."\n";
