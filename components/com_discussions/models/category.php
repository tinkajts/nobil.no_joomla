    ...
    /**
   	...
   	function getHtmlBoxTop() {
   		...
   		if ( empty( $this->_htmlBoxTop)) {
               ...
               $sql = "SELECT html_box_category_top FROM ".$db->nameQuote( '#__discussions_configuration')." WHERE id='1'";
    ...
    /**
   	...
   	function getHtmlBoxBottom() {
   		...
   		if ( empty( $this->_htmlBoxBottom)) {
               ...
               $sql = "SELECT html_box_category_bottom FROM ".$db->nameQuote( '#__discussions_configuration')." WHERE id='1'";
