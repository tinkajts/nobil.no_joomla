	...
	loadFeeds: function (options) 
  	{
    	...
    	this.feedGoogle = new google.feeds.Feed(feedOptions.linkRSS);
	    	...
	    	if (!result.error) 
	      	{
	        	...
	        	//var modal = (feedOptions.style_modal) ? 'modal' : '';
	        	var modal = '';
	        	//var modalSize = (feedOptions.style_modal_size) ? feedOptions.style_modal_size : 'x: 800, y: 600';
	        	var modalSize = '';
	        	//var modalRel = (feedOptions.style_modal) ? 'rel="{handler:\'iframe\', size: {'+modalSize+'} }"' : '';  
	        	var modalRel = '';
	        	...
	        	for (var i = 0; i < count; i++) 
	            {
	                ...
	                if (entry.publishedDate && feedOptions.style_show_date == 1)
	                {
	                     ...
	                     var dateHTML 		= '<div class="cf-feed-date">'+ date.format("dd. mmm yyyy"); + author +'</div>';
