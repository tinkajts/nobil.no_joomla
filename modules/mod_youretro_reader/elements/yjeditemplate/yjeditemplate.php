...
defined('_JEXEC') or die('Restricted access');
		...
		$path		= JPATH_ROOT.DS."modules".DS.$yj_mod_name.DS."tmpl";
		...
		if ( is_array($folders) )
		{
			foreach ($folders as $key=>$folder)
			{
				...
				$options[] = JHTML::_('select.option', $folder.DS.'default.php', $folder);
			}
		} ;
...
////////////////////////////////////////////////////////////////////
		if(isset($_POST['yjme_selected'])){
			...
			global $yjme_name_only;
			$yjme_name_only 			= "Default".DS."default.php";
		}
		global $yjme_file_dir;
		$yjme_file_dir 			= JPATH_ROOT."modules".DS.$yj_mod_name.DS."tmpl".DS;
		global $yjme_file;
	...
	function getedit_file(){
		...
		$yjme_file_dir 			= JPATH_ROOT.DS."modules".DS.$yj_mod_name.DS."tmpl".DS;
		$yjme_file 				= $yjme_file_dir.$yjme_name_only;
