...
window.addEvent('domready', function() {
				...
				$('yjme_spin').set('text', 'Saving your Template file please wait...');
			});
});
</script>
</head>
<body class="create filedit">
	<div id="yjme_saveresponse">
		<div id="yjme_spin">
		</div>
	</div>
	<div id="yjme_edit">
		...
		<fieldset id="yjme_fileview">
			<legend><?php echo JText::_( 'EDIT_TMPL_FILE' ). $send_msg; ?></legend>
			<?php
...
<script>
	...
	height: "350px",
	parserfile: ["parsefull-min.js"],
	stylesheet: ["<?php echo $baselink ?>elements/cmc/css/xhtml-min.css"],
