...
window.addEvent('domready',function() {
  ...
  // Validation.
	...
	onSend: function(){
        ...
        responsetext.set('text', 'Creating your template please wait...');
    },
	 onComplete: function(){
	...
	<div id="createholder">
		<div class="inside">
			<form action="<?php echo $yj_element ?>.php" method="post" id="yjcreate">
				<h3><?php echo JText::_('ENTER_TEMPLATE_NAME') ?></h3>
				<div id="typeholder">
					<input  id="foldername" class="minLength:4" type="text" name="foldername" value="" />
					<span class="button">
